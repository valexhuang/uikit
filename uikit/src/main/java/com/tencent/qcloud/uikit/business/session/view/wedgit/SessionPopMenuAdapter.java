...
public class SessionPopMenuAdapter extends BaseAdapter {

    private List<PopMenuAction> dataSource = new ArrayList<>();

    public SessionPopMenuAdapter() {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(ILiveUIKit.getAppContext()).inflate(R.layout.session_pop_menu_adapter, parent, false);
