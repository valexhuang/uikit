...
public class SelfInfoPanel extends LinearLayout implements ISelfInfoPanel, View.OnClickListener {
    ...
    private TextView mNickName, mAccount, mSignature;
    ...
    private ListView mFirstItemList, mSecondItemList;
    ...
    public void initPersonalInfo(PersonalInfoBean info) {
        this.mInfo = info;
        GlideEngine.loadImage(mUserIcon, info.getIconUrl());
    ...
    private void buildPopMenu() {
        if (mDialog == null) {
            ...
            mModifyNickNameBtn.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    PopWindowUtil.buildEditorDialog(getContext(), getResources().getString(R.string.modify_nick_name), "", getResources().getString(R.string.cancel), getResources().getString(R.string.sure), new PopWindowUtil.EnsureListener() {
            ...
            mModifyNickNameBtn.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    PopWindowUtil.buildEditorDialog(getContext(), getResources().getString(R.string.modify_signature), "", getResources().getString(R.string.cancel), getResources().getString(R.string.sure), new PopWindowUtil.EnsureListener() {
